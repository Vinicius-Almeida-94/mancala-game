...
public class BoardService implements IBoardService {
    ...
    @Override
    public BoardStatus getStatus(Board board) {
        return new BoardStatus(getStatusPlayersPits(board.getPlayersPits()));
    }

    @Override
    public BoardStatus move(Board board, Player player, int position) {
        var playersPits = board.getPlayersPits();
    ...
    @Override
    public BoardStatus takeOpponentStones(Board board, Player player, int playerPosition, int opponentPosition) {
        var playersPits = board.getPlayersPits();
