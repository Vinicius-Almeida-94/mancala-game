...
public class BoardTest {
    ...
    public void invalidPositionMove() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> board.move(Player.PLAYER1, 0));
        Assertions.assertThrows(IllegalArgumentException.class, () -> board.move(Player.PLAYER1, 6));
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> board.move(Player.PLAYER1, -1));
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> board.move(Player.PLAYER1, 7));
    }

    @Test
    public void samePlayerMove() {
        var board = new Board(6);
        var status = board.move(Player.PLAYER1, 0);
    ...
    public void finishAtOtherPlayerMove() {
        var board = new Board(6);
        var status = board.move(Player.PLAYER1, 1);
        Assertions.assertSame(Player.PLAYER1, status.getCurrentPlayer());
    ...
    public void notAddOpponentBigPitTest() {
        ...
        var status = board.move(Player.PLAYER1, 5);
        Assertions.assertSame(Player.PLAYER1, status.getCurrentPlayer());
        Assertions.assertSame(Player.PLAYER1, status.getFinishPitOwner());
        Assertions.assertEquals(0, status.getFinalPosition());
        var playersPits = status.getPlayersPits();
    ...
    public void invalidTakeOpponentPosition() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> emptyBoard.takeOpponentStones(Player.PLAYER1, 0, 0));
        Assertions.assertThrows(IllegalArgumentException.class, () -> emptyBoard.takeOpponentStones(Player.PLAYER1, 6, 6));
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> emptyBoard.takeOpponentStones(Player.PLAYER1, -1, -1));
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> emptyBoard.takeOpponentStones(Player.PLAYER1, 7, 7));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Board(2).takeOpponentStones(Player.PLAYER1, 0, 0));
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> board.takeOpponentStones(Player.PLAYER1, 0, 0));
    }

    @Test
    public void takeOpponentStonesTest() {
        var board = new Board(1);
        var playersPits = board.takeOpponentStones(Player.PLAYER1, 0, 5).getPlayersPits();
